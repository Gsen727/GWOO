...
if UAV.PointDim<3
    ...
    for i = 1:UAV.num
        ...
        hold on
        plot(UAV.G(i,1),UAV.G(i,2),'pk','LineWidth',1,'MarkerSize',10)
        hold on
    end
...
%     hold on
    plot3(5*x2,5*y2,5*z2,'r-.','LineWidth',2)
    hold on
    drawsphere(1500,1500,20,460,true)
     hold on
    drawsphere(2500,2000,20,560,true)
    
         hold on
    drawsphere(3500,1300,10,320,true)
        
         hold on
    drawsphere(3400,2900,10,600,true)
          hold on
    drawsphere(4000,2100,10,280,true)
    
          hold on
    drawsphere(1800,2500,10,420,true)
     
          hold on
    drawsphere(2500,3500,10,480,true)
...
%      hold on
    ...
    for i = 2:2
        ...
        hold on
        plot3(UAV.G(i,1),UAV.G(i,2),UAV.G(i,3),'pk','LineWidth',1.3,'MarkerSize',13)
        hold on
    end
    for i = 1:size(UAV.Menace.radar,1)
